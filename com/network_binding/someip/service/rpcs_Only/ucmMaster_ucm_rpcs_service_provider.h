#ifndef UCM_MASTER_UCM_PROVIDER_RPCS_H
#define UCM_MASTER_UCM_PROVIDER_RPCS_H
...
namespace ara
{
    namespace com
    {
        namespace someip
        {
            ...
            namespace sd
            {
                class UCMMaster_UCM_RPCSServiceProvider
                {
                public:
                    /******************* attributes ********************************/
                ...
                public:
                    ...
                    UCMMaster_UCM_RPCSServiceProvider(
                        uint16_t serviceId,
                        uint16_t instanceId,
                    ...
                    virtual std::vector<uint8_t> GetIdImp() = 0;
                    bool GetId(const std::vector<uint8_t> &input, std::vector<uint8_t> &output);

                    virtual std::vector<uint8_t> GetSwClusterChangeInfoImp() = 0;
                    ...
                    virtual std::vector<uint8_t> GetHistoryImp(const std::vector<uint8_t> &list) = 0;
                    bool GetHistory(const std::vector<uint8_t> &input, std::vector<uint8_t> &output) ;

                    virtual std::vector<uint8_t> GetSwClusterManifestInfoImp(const std::vector<uint8_t> &list) = 0;
                    ...
                    virtual std::vector<uint8_t> TransferStartImp(const std::vector<uint8_t> &list) = 0;
