#ifndef UCM_MASTER_UCM_REQUESTER_RPCS_H
#define UCM_MASTER_UCM_REQUESTER_RPCS_H
...
namespace ara
{
    namespace com
    {
        namespace someip
        {
            ...
            namespace sd
            {
                class UCMMaster_UCM_RPCSServiceRequester
                {
                public: 
                    /******************************* attributes ******************************/
                ...
                public:
                    /******************* constructor  *******************************/
                    UCMMaster_UCM_RPCSServiceRequester(
                        uint16_t serviceId,
                        uint16_t instanceId,
