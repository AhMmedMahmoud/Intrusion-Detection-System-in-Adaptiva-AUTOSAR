// headers
#include <iostream>
#include "../../language_binding/ucm_interfaces/ucmMaster_ucm_proxy.h"
#include <thread>
...
int main()
{
    ...
    if(!handles.empty())
    {
        ...
        std::future<bool> futureObj3 = myProxy.GetSwClusterInfo(output3);

        if(futureObj3.get())
        {
            std::cout << "result of GetSwClusterInfo : ";
        ...
        std::future<bool> futureObj3 = myProxy.Cancel(input,output3);
