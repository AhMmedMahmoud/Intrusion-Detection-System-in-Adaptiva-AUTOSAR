...
static const uint16_t c_Udp_port = 8000;
...
namespace ara 
{
    namespace com
    {
        ...
        {
            /***************** constructor ************************/
            TriggerInSkelton::TriggerInSkelton( ara::com::InstanceIdentifier id) : FieldServiceProvider
                                                                    ( 
                                                                    c_ServiceId,        
                                                                    id.getInstanceId(),
                                                                    c_MajorVersion,                   
            ...
            /********************* deconstructor *******************/
            TriggerInSkelton::~TriggerInSkelton()
            {}
        }
    }
}
