#include "POTI_Management_Skeleton.h"  
...
static const uint16_t c_Udp_port = 6000;
...
namespace ara 
{
    namespace com
    {
        ...
        {
            /****************** constructor ************************************/
            POTI_Management_Skeleton::POTI_Management_Skeleton( ara::com::InstanceIdentifier id) : EventServiceProvider
                                                                    ( 
                                                                    c_ServiceId,        
                                                                    id.getInstanceId(),
                                                                    c_MajorVersion,                   
            ...
            /********************* deconstructor *******************/
            POTI_Management_Skeleton::~POTI_Management_Skeleton()
            {}
        }
    }
}
