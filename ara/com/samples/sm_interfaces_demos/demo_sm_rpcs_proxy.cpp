// headers
#include <iostream>
#include "../../language_binding/sm_interfaces/SM_RPCSProxy.h"
#include <thread>
...
int main()
{
    ...
    auto handles = SM_RPCS_Proxy::findSerivce(id);
    ...
    if(!handles.empty())
    {
        SM_RPCS_Proxy myProxy(handles[0]);
