#include "TriggerInOutSkeleton.h"
...
static const uint16_t c_Udp_port = 7000;
...
namespace ara 
{
    namespace com
    {
        ...
        {
            /***************** constructor ************************/
            TriggerInOutSkelton::TriggerInOutSkelton( ara::com::InstanceIdentifier id) : FieldServiceProvider
                                                                    ( 
                                                                    c_ServiceId,        
                                                                    id.getInstanceId(),
                                                                    c_MajorVersion,                   
            ...
            /********************* deconstructor *******************/
            TriggerInOutSkelton::~TriggerInOutSkelton()
            {}
        }
    }
}
