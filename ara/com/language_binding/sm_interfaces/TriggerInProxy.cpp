...
namespace ara 
{
    namespace com
    {
        ...
        {    
            /******************** constructors ************************/
            TriggerInProxy::HandleType::HandleType(InstanceIdentifier id,int16_t p): identifier{id},
                                                                    port_no{p}
            {}

            /************ setters and getters *************************/
            void TriggerInProxy::HandleType::setId(InstanceIdentifier id)
            {   identifier=id;  }

            void TriggerInProxy::HandleType::setPort(int16_t p)
            {   port_no=p;  }

            int16_t TriggerInProxy::HandleType::getPort()const
            {   return port_no; }
            ...
            /************************* constructor **************************/
            TriggerInProxy::TriggerInProxy (HandleType &handle)
            {
