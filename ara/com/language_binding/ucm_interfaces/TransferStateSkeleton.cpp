#include "TransferStateSkeleton.h"
...
static const uint16_t c_Udp_port = 1500;
...
namespace ara 
{
    namespace com
    {
        namespace skelton
        {
            TransferStateSkeleton::TransferStateSkeleton( ara::com::InstanceIdentifier id) : FieldServiceProvider
                                                                    ( 
                                                                    c_ServiceId,        
                                                                    id.getInstanceId(),
                                                                    c_MajorVersion,                   
            ...
            /********************* deconstructor *******************/
            TransferStateSkeleton::~TransferStateSkeleton()
            {}
        }
    }
}
