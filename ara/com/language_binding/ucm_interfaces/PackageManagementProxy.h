        ...
        {    
            ...
            class currentStatusProxy
            {
                public:
                    ...
                    /************************* constructor **************************/
                    currentStatusProxy (HandleType &handle);
                    ...
                    currentStatusProxy(const currentStatusProxy &other) = delete;
                    currentStatusProxy& operator=(const currentStatusProxy &other) = delete;
