#include "SwNameVersionSkeleton.h"
...
static const uint16_t c_Udp_port = 1300;
...
namespace ara 
{
    namespace com
    {
        namespace skelton
        {
            requestedPackageSkelton::requestedPackageSkelton( ara::com::InstanceIdentifier id) : FieldServiceProvider
                                                                    ( 
                                                                    c_ServiceId,        
                                                                    id.getInstanceId(),
                                                                    c_MajorVersion,                   
            ...
            /********************* deconstructor *******************/
            requestedPackageSkelton::~requestedPackageSkelton()
            {}
        }
    }
}
