#include "PackageManagementSkeleton.h"
...
static const uint16_t c_Udp_port = 1600;
...
namespace ara 
{
    namespace com
    {
        namespace skelton
        {
            currentStatusSkelton::currentStatusSkelton( ara::com::InstanceIdentifier id) : FieldServiceProvider
                                                                    ( 
                                                                    c_ServiceId,        
                                                                    id.getInstanceId(),
                                                                    c_MajorVersion,                   
            ...
            /********************* deconstructor *******************/
            currentStatusSkelton::~currentStatusSkelton()
            {}
        }
    }
}
