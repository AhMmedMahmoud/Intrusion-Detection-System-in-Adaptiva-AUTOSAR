...
static const uint16_t c_Udp_port = 5000;
...
namespace ara 
{
    namespace com
    {
        ...
        {
            /****************** constructor ************************************/
            CAM_VDP_Skeleton::CAM_VDP_Skeleton( ara::com::InstanceIdentifier id) : EventServiceProvider
                                                                    ( 
                                                                    c_ServiceId,        
                                                                    id.getInstanceId(),
                                                                    c_MajorVersion,                   
            ...
            /********************* deconstructor *******************/
            CAM_VDP_Skeleton::~CAM_VDP_Skeleton()
            {}
        }
    }
}
