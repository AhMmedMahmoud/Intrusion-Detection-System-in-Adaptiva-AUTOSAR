...
static const uint16_t c_Udp_port = 4000;
...
namespace ara 
{
    namespace com
    {
        ...
        {
            /****************** constructor ************************************/
            DENM_VDP_Skeleton::DENM_VDP_Skeleton( ara::com::InstanceIdentifier id) : EventServiceProvider
                                                                    ( 
                                                                    c_ServiceId,        
                                                                    id.getInstanceId(),
                                                                    c_MajorVersion,                   
            ...
            /********************* deconstructor *******************/
            DENM_VDP_Skeleton::~DENM_VDP_Skeleton()
            {}
        }
    }
}
