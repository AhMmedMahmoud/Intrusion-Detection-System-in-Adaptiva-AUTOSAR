#include "CAM_Control_Skeleton.h"   
...
static const uint16_t c_Udp_port = 1900;
...
namespace ara 
{
    namespace com
    {
        ...
        {
            /****************** constructor ************************************/
            CAM_Control_Skeleton::CAM_Control_Skeleton( ara::com::InstanceIdentifier id) : EventServiceProvider
                                                                    ( 
                                                                    c_ServiceId,        
                                                                    id.getInstanceId(),
                                                                    c_MajorVersion,                   
            ...
            /********************* deconstructor *******************/
            CAM_Control_Skeleton::~CAM_Control_Skeleton()
            {}
        }
    }
}
