...
static const uint16_t c_Udp_port = 2000;
...
namespace ara 
{
    namespace com
    {
        ...
        {
            /****************** constructor ************************************/
            POTI_VDP_Skeleton::POTI_VDP_Skeleton( ara::com::InstanceIdentifier id) : EventServiceProvider
                                                                    ( 
                                                                    c_ServiceId,        
                                                                    id.getInstanceId(),
                                                                    c_MajorVersion,                   
            ...
            /********************* deconstructor *******************/
            POTI_VDP_Skeleton::~POTI_VDP_Skeleton()
            {}
        }
    }
}
