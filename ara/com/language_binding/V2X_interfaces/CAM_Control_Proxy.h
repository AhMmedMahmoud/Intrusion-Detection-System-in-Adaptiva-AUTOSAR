#ifndef CAM_CONTROL_PROXY_H     
#define CAM_CONTROL_PROXY_H     

#include "../../network_binding/someip/service/event_Only/event_service_requester.h"
        ...
        {    
            ...
            class CAM_Control_Proxy
            {
                public:
                    ...
                    /************************* constructor **************************/
                    CAM_Control_Proxy (HandleType &handle);
                    ...
                    CAM_Control_Proxy(const CAM_Control_Proxy &other) = delete;
                    CAM_Control_Proxy& operator=(const CAM_Control_Proxy &other) = delete;
