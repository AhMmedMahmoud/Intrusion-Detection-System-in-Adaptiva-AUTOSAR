#ifndef REQUESTER_FIELD_H
#define REQUESTER_FIELD_H
...
#include "../../fields/socket_field_client.h"
...
namespace ara
{
    namespace com
    {
        namespace someip
        {
            ...
            namespace sd
            {
                class FieldServiceRequester
                {
                public:                     
                    SockeKFieldClient *fieldClient;
